...
+ (instancetype) getImage:(NSString*)url queryArguments:(NSDictionary*)queryArguments scale:(float)imageScale completionHandler:(void (^)(NSError* error, NSImage* image))completionHandler
{
	...
	return [self executeRequest:request completionHandler:^(UUHttpClientResponse *response)
	{
		...
		{
			// FIXME
//			image = [NSImage imageWithData:response.rawResponse scale:imageScale];
		}
...
+ (instancetype) getImage:(NSString*)url queryArguments:(NSDictionary*)queryArguments scale:(float)imageScale user:(NSString *)user password:(NSString *)password completionHandler:(void (^)(NSError *, NSImage *))completionHandler
{
...
+ (UUHttpClientResponse*) synchronousGetImage:(NSString*)url queryArguments:(NSDictionary*)queryArguments scale:(float)imageScale
{
	...
	{
		// FIXME
//		NSImage* image = [NSImage imageWithData:response.rawResponse scale:imageScale];
