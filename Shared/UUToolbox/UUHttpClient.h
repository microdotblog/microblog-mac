...
// that for the majority of web transactions you want an actual object back from your URL request.  Whether that is a JSON Dictionary, a NSImage
...
+ (instancetype) getImage:(NSString*)url queryArguments:(NSDictionary*)queryArguments scale:(float)imageScale completionHandler:(void (^)(NSError* error, NSImage* image))completionHandler;
...
+ (instancetype) getImage:(NSString*)url queryArguments:(NSDictionary*)queryArguments scale:(float)imageScale user:(NSString*)user password:(NSString*)password completionHandler:(void (^)(NSError* error, NSImage* image))completionHandler;
