...
static NSString* const kAutosavedDraftDidCreateNotification = @"MBAutosavedDraftDidCreate";
static NSString* const kAutosavedDraftDidUpdateNotification = @"MBAutosavedDraftDidUpdate";
static NSString* const kAutosavedDraftPostIDKey = @"post_id";
...
static NSString* const kShowInfoNotification = @"MBShowInfoNotification";
